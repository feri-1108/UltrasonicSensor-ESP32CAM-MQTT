 ...
 * 
 * Este programa lee el sensor ultrasonico con la biblioteca Ultrasonic de Erick Simoes
 * en suversion 3.0.0. Se mezcla con el programa ESP32CAM-MQTT basic del repositorio Codigo-IoT
 * 
...
//Datos de WiFi
const char* ssid = "INFINITUMAB6C_2.4";  // Aquí debes poner el nombre de tu red
const char* password = "b4c32G60MM";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "192.168.1.83"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(192,168,1,83);
